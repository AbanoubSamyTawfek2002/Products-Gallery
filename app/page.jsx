...
import { Search, Filter, SortAsc, ShoppingCart, Heart, Star, Moon, Sun, Loader2 } from "lucide-react"
      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Update the header section to show user status */}
            <div className="flex items-center space-x-4">
              {/* Theme Toggle Button */}
              <Button
                variant="ghost"
              ...
              <Card key={product.id} className="group hover:shadow-lg transition-shadow">
                <CardContent className="p-4">
                  <div className="relative mb-4">
                    ...
                    {/* Update the favorite button with loading state */}
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <CardFooter className="p-4 pt-0">
                  <div className="flex items-center justify-between w-full">
                    ...
                    {/* Update the add to cart button with loading state */}
                    <Button
                      size="sm"
